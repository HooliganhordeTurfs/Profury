...
import gearIcon from '~/img/profury/interface/nav/gear.svg';
import historyIcon from '~/img/profury/interface/nav/history.svg';
import etherscanIcon from '~/img/profury/interface/nav/etherscan.svg';
import disconnectIcon from '~/img/profury/interface/nav/disconnect.svg';
